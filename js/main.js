...
if (userPrefersDark) {
  ...
  modeIcon.src = "staticimages/dark-icon.png"; // Change to dark icon
}
...
toggleButton.addEventListener("click", () => {
  ...
  if (document.body.classList.contains("dark-mode")) {
    modeIcon.src = "staticimages/dark-icon.png"; // Set dark mode icon
    localStorage.setItem("darkMode", "enabled");
  } else {
    modeIcon.src = "staticimages/light-icon.png"; // Set light mode icon

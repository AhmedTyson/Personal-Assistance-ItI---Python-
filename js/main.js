...
if (userPrefersDark) {
  ...
  modeIcon.src = "static\images/dark-icon.png"; // Change to dark icon
}
...
toggleButton.addEventListener("click", () => {
  ...
  if (document.body.classList.contains("dark-mode")) {
    modeIcon.src = "static\images/dark-icon.png"; // Set dark mode icon
    localStorage.setItem("darkMode", "enabled");
  } else {
    modeIcon.src = "static\images/light-icon.png"; // Set light mode icon
